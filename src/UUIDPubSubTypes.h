...
#ifndef _UNIQUE_IDENTIFIER_MSGS_MSG_UUID_PUBSUBTYPES_H_
#define _UNIQUE_IDENTIFIER_MSGS_MSG_UUID_PUBSUBTYPES_H_
...
#endif // _UNIQUE_IDENTIFIER_MSGS_MSG_UUID_PUBSUBTYPES_H_
