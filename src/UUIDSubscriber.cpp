...
void UUIDSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void UUIDSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
    SampleInfo info;
